...
lite_url="https://github.com/xxf098/LiteSpeedTest/releases/download/v0.15.0/lite-linux-amd64-v0.15.0.gz"
if [ ! -f $lite_file_path ]; then
    ...
    #       "outputMode": 1  // 0: base64 1: pic path 2: no pic 3: json 4: txt
    echo '{"group":"job","speedtestMode":"pingonly","pingMethod":"tcpping","sortMethod":"rspeed","concurrency":20,"testMode":2,"subscription":"","timeout":16,"language":"en","fontSize":24,"theme":"rainbow","unique":true,"outputMode":4}' > $lite_file_config_path
